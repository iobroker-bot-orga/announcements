...
async function test(context){
    ...
    let isMaterialize = false;
    
    if (ioPackageJson.common.materialize || ioPackageJson.common.materializeTab) {
        isMaterialize = true;
    }

    if (ioPackageJson.common.adminUI) {
        if ((ioPackageJson.common.adminUI.config === 'materialize') || (ioPackageJson.common.adminUI.custom === 'materialize')) {
            isMaterialize = true;
        }
        if ((ioPackageJson.common.adminUI.config !== 'materialize') && (ioPackageJson.common.adminUI.custom !== 'materialize')) {
            isMaterialize = false;
